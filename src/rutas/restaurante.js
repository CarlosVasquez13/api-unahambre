 ...
 */
router.post('/api/g_insertar-restaurante', autenticar, function (req, res, next) {
...
router.get('/api/g_mostrar_menus', function (req, res, next) {
...
router.get('/api/g_mostrar_platillos', function (req, res, next) {
